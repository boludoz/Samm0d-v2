...
Func GetTrainedAndPreDetect($sMode = "Troops", $bTest = False)
	...
	_CaptureRegion2()
	$vDelete = findMultipleQuick($g_sSamM0dImageLocation & "\Siege\Sprites\", 11, "17,190,842,199", "Delete", False, True, 50)
	...
	If IsArray($vDelete) Then
		...
		For $i = UBound($vDelete) - 1 To 0 Step -1
			...
			Local $aMatrix[1][4] = [[$aTmpArray[0], $aTmpArray[1], False, False]]
