...
Global Const $aButtonAttackFindMatch[9] 		= [585, 395, 775, 490, 619, 403, 0xFFD155, 30, "=-= Find A Match"] ; Attack Page Find A Match Button
Global Const $aButtonAttackFindMatchWShield[9]  = [585, 395, 775, 490, 619, 403, 0xFFD155, 30, "=-= Find A Match (With Shield)"] ; Attack Page Find A Match Button With Shield
...
;
;If QuickMIS("BC1", $sEdit, 709, 446, 843, 619, True, False) Then Click($g_iQuickMISX + 709, $g_iQuickMISY + 446, 1)
;If QuickMIS("BC1", $sRequest, 709, 446, 843, 619, True, False) Then Click($g_iQuickMISX + 709, $g_iQuickMISY + 446, 1)
...
Func CheckClickMsg(ByRef $x, ByRef $y, ByRef $times, ByRef $speed, ByRef $MsgCode)
	...
	Switch $MsgCode
		...
		;Case "#0150"
			...
			;	Return HMLClickPR($aButtonAttackFindMatch,$x,$y,0)
