...
Func SaveConfig_600_29_DB()
	...
	_Ini_Add("attack", "DBKingAtk_", BitAND($g_aiAttackUseHeroes[$DB], $eHeroKing))
	_Ini_Add("attack", "DBQueenAtk_", BitAND($g_aiAttackUseHeroes[$DB], $eHeroQueen))
	_Ini_Add("attack", "DBWardenAtk_", BitAND($g_aiAttackUseHeroes[$DB], $eHeroWarden))
	_Ini_Add("attack", "DBChampionAtk_", BitAND($g_aiAttackUseHeroes[$DB], $eHeroChampion))
...
Func SaveConfig_600_29_LB()
	...
	_Ini_Add("attack", "ABKingAtk_", BitAND($g_aiAttackUseHeroes[$LB], $eHeroKing))
	_Ini_Add("attack", "ABQueenAtk_", BitAND($g_aiAttackUseHeroes[$LB], $eHeroQueen))
	_Ini_Add("attack", "ABWardenAtk_", BitAND($g_aiAttackUseHeroes[$LB], $eHeroWarden))
	_Ini_Add("attack", "ABChampionAtk_", BitAND($g_aiAttackUseHeroes[$LB], $eHeroChampion))
